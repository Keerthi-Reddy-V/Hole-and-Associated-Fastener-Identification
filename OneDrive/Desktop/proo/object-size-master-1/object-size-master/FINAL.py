    ...
    for cnt in cnts:
        ...
        if counter==2:
                    ...
                    if 0.1<=ret<=1.0:
                        ...
                        print("Diameter(Millimeter):{} \n Pitch(Coarse): {} \n TapDril(Coarse):{} \n Pitch(Fine): {}  \n Tap Drill(Fine):{} ".format('M1','0.25','0.75','0.2','0.8'))
                        res="Diameter(Millimeter):{} \n Pitch(Coarse): {} \n TapDril(Coarse):{} \n Pitch(Fine): {} \n Tap Drill(Fine):{} ".format('M1','0.25','0.75','0.2','0.8')
                    if 1.1<=ret<=1.3:
                        print("Diameter(Millimeter):{} \n Pitch(Coarse): {} \n TapDril(Coarse):{} \n Pitch(Fine): {}  \n Tap Drill(Fine):{} ".format('M1.2','0.25','0.95','0.2','1'))
                        res="Diameter(Millimeter):{} \n Pitch(Coarse): {} \n TapDril(Coarse):{} \n Pitch(Fine): {}  \n Tap Drill(Fine):{} ".format('M1.2','0.25','0.95','0.2','1')	


                    if 1.4<ret<=1.5:
                        print("Diameter(Millimeter):{} \n Pitch(Coarse): {} \n TapDril(Coarse):{} \n Pitch(Fine): {}  \n Tap Drill(Fine):{} ".format('M1.4','0.3','1.1','0.2','1.2'))
                        res="Diameter(Millimeter):{} \n Pitch(Coarse): {} \n TapDril(Coarse):{} \n Pitch(Fine): {}  \n Tap Drill(Fine):{} ".format('M1.4','0.3','1.1','0.2','1.2')


                    if 1.6<=ret<=1.79:
                        print("Diameter(Millimeter):{} \n Pitch(Coarse): {} \n TapDril(Coarse):{} \n Pitch(Fine): {}  \n Tap Drill(Fine):{} ".format('M1.6','0.35','1.25','0.2','1.4'))	
                        res="Diameter(Millimeter):{} \n Pitch(Coarse): {} \n TapDril(Coarse):{} \n Pitch(Fine): {}  \n Tap Drill(Fine):{} ".format('M1.6','0.35','1.25','0.2','1.4')


                    if 1.8<=ret<=1.9:
                        print("Diameter(Millimeter):{} \n Pitch(Coarse): {} \n TapDril(Coarse):{} \n Pitch(Fine): {}  \n Tap Drill(Fine):{} ".format('M1.8','0.35','1.45','0.2','1.6'))
                        res="Diameter(Millimeter):{} \n Pitch(Coarse): {} \n TapDril(Coarse):{} \n Pitch(Fine): {}  \n Tap Drill(Fine):{} ".format('M1.8','0.35','1.45','0.2','1.6')



                    if 2.0<=ret <=2.4:#2.0,2.4
                        print("Diameter(Millimeter):{} \n Pitch(Coarse): {} \n TapDril(Coarse):{} \n Pitch(Fine): {}  \n Tap Drill(Fine):{} ".format('M2','0.4','1.6','0.25','1.75'))
                        res="Diameter(Millimeter):{} \n Pitch(Coarse): {} \n TapDril(Coarse):{} \n Pitch(Fine): {}  \n Tap Drill(Fine):{} ".format('M2','0.4','1.6','0.25','1.75')


                    if 2.5<=ret<=2.9:
                        print("Diameter(Millimeter):{} \n Pitch(Coarse): {} \n TapDril(Coarse):{} \n Pitch(Fine): {}  \n Tap Drill(Fine):{} ".format('M2.5','0.45', '2', '0.35','2.1'))
                        res="Diameter(Millimeter):{} \n Pitch(Coarse): {} \n TapDril(Coarse):{} \n Pitch(Fine): {}  \n Tap Drill(Fine):{} ".format('M2.5','0.45', '2', '0.35','2.1')

                    if 3.0<=ret<=3.4:
                        print("Diameter(Millimeter):{} \n Pitch(Coarse): {} \n TapDril(Coarse):{} \n Pitch(Fine): {}  \n Tap Drill(Fine):{} ".format('M3','0.5','2.5','0.35','2.6'))
                        res="Diameter(Millimeter):{} \n Pitch(Coarse): {} \n TapDril(Coarse):{} \n Pitch(Fine): {}  \n Tap Drill(Fine):{} ".format('M3','0.5','2.5','0.35','2.6')


                    if 3.5<=ret<=3.9:
                        print("Diameter(Millimeter):{} \n Pitch(Coarse): {} \n TapDril(Coarse):{} \n Pitch(Fine): {}  \n Tap Drill(Fine):{} ".format('M3.5','0.6', '2.9', '0.35','3.1'))
                        res="Diameter(Millimeter):{} \n Pitch(Coarse): {} \n TapDril(Coarse):{} \n Pitch(Fine): {}  \n Tap Drill(Fine):{} ".format('M3.5','0.6', '2.9', '0.35','3.1')
                    if 4.0<=ret<=4.9:
                        print("Diameter(Millimeter):{} \n Pitch(Coarse): {} \n TapDril(Coarse):{} \n Pitch(Fine): {}  \n Tap Drill(Fine):{} ".format('M4','0.7', '3.3', '0.5', '3.5'))
                        res="Diameter(Millimeter):{} \n Pitch(Coarse): {} \n TapDril(Coarse):{} \n Pitch(Fine): {}  \n Tap Drill(Fine):{} ".format('M4','0.7', '3.3', '0.5', '3.5')

                    if 5.0<=ret<=5.9:
                        print("Diameter(Millimeter):{} \n Pitch(Coarse): {} \n TapDril(Coarse):{} \n Pitch(Fine): {}  \n Tap Drill(Fine):{} ".format('M5','0.8', '4.2', '0.5', '4.5'))
                        res="Diameter(Millimeter):{} \n Pitch(Coarse): {} \n TapDril(Coarse):{} \n Pitch(Fine): {}  \n Tap Drill(Fine):{} ".format('M5','0.8', '4.2', '0.5', '4.5')                                        


                    if 6.0<=ret<=6.9:
                        print("Diameter(Millimeter):{} \n Pitch(Coarse): {} \n TapDril(Coarse):{} \n Pitch(Fine): {}  \n Tap Drill(Fine):{} ".format('M6','1', '5', '0.75', '5.2'))
                        res="Diameter(Millimeter):{} \n Pitch(Coarse): {} \n TapDril(Coarse):{} \n Pitch(Fine): {}  \n Tap Drill(Fine):{} ".format('M6','1', '5', '0.75', '5.2')
                    if 7.0<=ret<=7.9:
                        print("Diameter(Millimeter):{} \n Pitch(Coarse): {} \n TapDril(Coarse):{} \n Pitch(Fine): {}  \n Tap Drill(Fine):{} ".format('M7','1', '6', '0.75', '6.2'))
                        res="Diameter(Millimeter):{} \n Pitch(Coarse): {} \n TapDril(Coarse):{} \n Pitch(Fine): {}  \n Tap Drill(Fine):{} ".format('M7','1', '6', '0.75', '6.2')



                    if 8.0<=ret<=9.9:
                        print("Diameter(Millimeter):{} \n Pitch(Coarse): {} \n TapDril(Coarse):{} \n Pitch(Fine): {}  \n Tap Drill(Fine):{} ".format('M8','1.25', '6.8', '0.75', '7.2'))
                        res="Diameter(Millimeter):{} \n Pitch(Coarse): {} \n TapDril(Coarse):{} \n Pitch(Fine): {}  \n Tap Drill(Fine):{} ".format('M8','1.25', '6.8', '0.75', '7.2')

                    if 10.0<=ret<=11.9:
                        print("Diameter(Millimeter):{} \n Pitch(Coarse): {} \n TapDril(Coarse):{} \n Pitch(Fine): {}  \n Tap Drill(Fine):{} ".format('M10','1.5', '8.5', '1.25', '9'))
                        res="Diameter(Millimeter):{} \n Pitch(Coarse): {} \n TapDril(Coarse):{} \n Pitch(Fine): {}  \n Tap Drill(Fine):{} ".format('M10','1.5', '8.5', '1.25', '9')
...
label=Label(win,text="Wall Hole Detector",font=("times",32,"bold underline"),bg="black",fg="white")
...
global output
output=Label(win,text="",font=("times",24,"bold underline"),bg="black",fg="white")
output.place(x=630,y=400)
